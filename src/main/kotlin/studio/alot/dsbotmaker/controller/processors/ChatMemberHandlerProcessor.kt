...
import studio.alot.avitowheelsparser.presentation.telegram.ChatMemberHandler

@Component
class ChatMemberHandlerProcessor(private val chatMemberHandler: ChatMemberHandler?) : Processor {
